"""Skill loading, scanning, formatting, and tool handlers.

Skills — listing in system prompt; bodies loaded on demand via load_skill tool,
or pre-injected for subagents.
"""
...
def tool_list_skills() -> str:
    meta = scan_skills_meta()
    if not meta:
        return "No skills available."
    return format_skills_listing(meta)
